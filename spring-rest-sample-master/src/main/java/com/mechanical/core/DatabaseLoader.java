...
import com.mechanical.topic.Topic;
import com.mechanical.topic.TopicRepository;
import com.mechanical.user.User;
import com.mechanical.user.UserRepository;
...
public class DatabaseLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        users.save(new User("zia", "mechanical", "zia566", "123456", new String[]{"ROLE_USER", "ROLE_ADMIN"}));
